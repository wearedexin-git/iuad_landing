# Landing Page - Art Direction & Copywriting | IUAD

Landing page per l'Open Day del Corso Triennale in Art Direction & Copywriting presso IUAD. **Sedi e date** (Milano, Napoli, una o entrambe) sono definite in `src/app/config/openday-config.json` e si riflettono su hero, form, email, redirect verso la pagina di ringraziamento e footer.
...
```json
{
  ...
  "course": ["corso triennale di i livello in art direction & copywriting"],
