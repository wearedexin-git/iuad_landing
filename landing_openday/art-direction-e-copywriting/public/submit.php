...
$data = [
    ...
    'lang'                => 'it',
    'course'              => $landingConfig['course'] ?? ['art direction & copywriting'],
    'origin'              => $origin,
...
$logoBase64 = 'https://www.accademiamoda.it/landing/art-direction-e-copywriting-b/assets/logo_iuad_black.png';

// ── Email 1: Conferma all'utente ───────────────────────────────────────────
$userSubject = $isOrientamento
    ? 'Prenotazione confermata – Orientamento Art Direction & Copywriting | IUAD'
    : 'Iscrizione confermata – Open Day Art Direction & Copywriting | IUAD';
$userBody = "
<!DOCTYPE html>
<html lang='it'>
...
") . "
                    ...
                    <tr>
                      <td style='font-family:Arial,sans-serif;font-size:14px;'>
                        ...
                        <span style='color:#201f1f;'> Art Direction & Copywriting</span>
                      </td>
                    </tr>
                  </table>
                </td>
...
$academySubject = $isOrientamento
    ? 'Nuova prenotazione Orientamento – Art Direction & Copywriting'
    : 'Nuova iscrizione Open Day – Art Direction & Copywriting';
$academyBody = "
<!DOCTYPE html>
<html lang='it'>
<head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,initial-scale=1'></head>
...
" . ($isOrientamento ? '' : "                  <p style='margin:0 0 8px;'><strong>Data Open Day:</strong> $selectedOpenDayDateLabelEscaped</p>
") . "                  <p style='margin:0 0 8px;'><strong>Indirizzo sede:</strong> $selectedCampusAddressEscaped</p>
                  <p style='margin:0 0 8px;'><strong>Corso:</strong> Art Direction & Copywriting</p>
