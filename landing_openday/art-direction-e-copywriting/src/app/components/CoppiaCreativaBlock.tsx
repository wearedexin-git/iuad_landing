        ...
        <div className="flex flex-col gap-8 md:gap-10 max-w-[670px]">
          <div className="flex flex-col gap-6">
            ...
            <p className="font-sarabun font-light text-[20px] md:text-[24px] lg:text-[28px] text-[#201f1f] leading-[1.4]">
              <span className="font-bold">Art Director e Copywriter sono il motore di ogni agenzia.</span> Insieme, trasformano l'identità di un brand in <span className="font-bold">idee</span>, <span className="font-bold">campagne social</span> e <span className="font-bold">spot pubblicitari</span>.
