        ...
        <div className="flex flex-col gap-8 md:gap-10 max-w-[670px]">
          <div className="flex flex-col gap-6">
            ...
            <p className="font-sarabun font-light text-[20px] md:text-[24px] lg:text-[28px] text-[#201f1f] leading-[1.4]">
              Durante il Biennio, studierai <span className="font-bold">Advertising</span> e <span className="font-bold">Branding</span>, ma imparerai anche a muoverti su terreni strategici come il Digital Marketing e la Pianificazione.
              Dai laboratori di <span className="font-bold">Craft Art</span>, dove darai forma alla tua creatività, fino alle frontiere dell'<span className="font-bold">Interaction Design</span>, acquisirai gli strumenti per gestire ogni fase della comunicazione contemporanea.
            </p>
          </div>
