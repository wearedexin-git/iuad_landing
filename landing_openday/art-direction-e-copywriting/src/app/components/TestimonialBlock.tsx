...
const testimonials: Testimonial[] = [
  {
    ...
    role: "Studente",
    quote:
      "La differenza l'hanno fatta i docenti: sono professionisti che lavorano in agenzia e ti chiedono lo stesso livello di qualità che pretendono dai loro colleghi. Grazie al biennio ho costruito un book solido che mi ha permesso di presentarmi ai colloqui con molta più sicurezza.",
  },
  {
    name: "Elena",
    role: "Junior",
    quote:
      "La conferma che fosse la scelta giusta è arrivata alla fine del biennio: ho iniziato a lavorare in agenzia appena conclusi gli studi. IUAD ti dà esattamente quello che serve per essere operativi subito: una mentalità professionale",
  },
  {
    name: "Luca",
    role: "Studente",
    quote:
      "Cercavo un ambiente che parlasse la mia lingua e l'ho trovato qui. Non è la solita scuola: è un laboratorio dove ti confronti ogni giorno con chi questo mestiere lo fa per davvero. Entri come studente ed esci con la testa già pronta per l'agenzia.",
  },
];
...
function QuoteIcon() {
  return (
    <div className="w-[50px] h-[35px] md:w-[69px] md:h-[48px] shrink-0">
      ...
      >
        <path d={svgPaths.p1bfd52c0} fill="#D06321" />
      </svg>
    </div>
  );
}
...
function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  return (
    <div className="bg-white flex flex-col gap-4 p-8 md:p-10 rounded-3xl border-2 border-[#d06321] w-full h-full">
      <QuoteIcon />
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-2">
          <EyeIcon variant="tiny" className="w-[42px] h-[42px] shrink-0" />
