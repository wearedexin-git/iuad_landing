...
type Session = {
  id: string;
  apiDateTime: string;
  /** Testo opzionale stampato dopo la data, es. "inglese" → "…, ore 11:00 (inglese)" */
  label?: string;
};
...
/** Open Day: solo sedi con almeno una sessione; orientamento: tutte le sedi configurate */
        ...
        <div className="bg-[#d06321] rounded-[24px] p-6 flex flex-col gap-3 w-full">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="flex flex-col gap-4">
              ...
              {/* Sede + Data: solo Open Day; orientamento non richiede la data */}
              {!IS_ORIENTAMENTO && SHOW_SEDE_AND_DATE_ROW && (
              ...
              {!IS_ORIENTAMENTO && SHOW_DATE_ONLY_FOR_SINGLE_CAMPUS && (
