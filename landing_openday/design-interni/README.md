# Landing Page - Design e Architettura degli Interni | IUAD

Landing page per l'Open Day del Corso Triennale in Design e Architettura degli Interni presso IUAD. **Sedi e date** (Milano, Napoli, una o entrambe) sono definite in `src/app/config/openday-config.json` e si riflettono su hero, form, email, redirect verso la pagina di ringraziamento e footer.
...
```json
{
  ...
  "course": ["design e architettura degli interni"],
