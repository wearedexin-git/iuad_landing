# Landing Page - Game Design | IUAD

Landing page per l'Open Day del Corso Triennale in Game Design presso IUAD. **Sedi e date** (Milano, Napoli, una o entrambe) sono definite in `src/app/config/openday-config.json` e si riflettono su hero, form, email, redirect verso la pagina di ringraziamento e footer.
...
```json
{
  ...
  "course": ["corso triennale di i livello in game design"],
