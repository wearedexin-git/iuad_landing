...
$data = [
    ...
    'lang'                => 'it',
    'course'              => $landingConfig['course'] ?? ['game design'],
...
$userSubject = $isOrientamento
    ? 'Iscrizione confermata – Orientamento Game Design | IUAD'
    : 'Iscrizione confermata – Open Day Game Design | IUAD';
$openDayDateRow = $isOrientamento ? '' : "
                    <tr>
                      <td style='padding-bottom:10px;font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#b2ab38;'>Data Open Day:</strong>
...
<body style='margin:0;padding:0;background:#fbf6c3;font-family:Arial,sans-serif;'>
  <table width='100%' cellpadding='0' cellspacing='0' style='background:#fbf6c3;padding:40px 20px;'>
    <tr><td align='center'>
      <table width='580' cellpadding='0' cellspacing='0' style='background:#ffffff;border-radius:24px;overflow:hidden;max-width:580px;width:100%;'>
        ...
        <tr>
          <td align='center' style='padding:36px 40px 24px;background:#ffffff;'>
            ...
            <h1 style='margin:0;font-size:22px;font-weight:bold;color:#b2ab38;font-family:Georgia,serif;'>
          ...
          <td style='padding:0 40px 40px;'>
            <table width='100%' cellpadding='0' cellspacing='0'>
              <tr>
                <td>
                  <!-- Titolo sezione -->
                  <p style='margin:0 0 12px;font-size:15px;font-weight:bold;color:#b2ab38;font-family:Arial,sans-serif;text-align:center;'>
                    Riepilogo Richiesta
                  </p>
                  <table width='100%' cellpadding='0' cellspacing='0'>
                  ...
                  <table width='100%' cellpadding='0' cellspacing='0' style='margin-top:16px;'>
                    <tr>
                      <td style='padding-bottom:10px;font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#b2ab38;'>Tipo Richiesta:</strong>
                        <span style='color:#201f1f;'> $requestTypeLabelEscaped</span>
                      </td>
                    </tr>
                    <tr>
                      <td style='padding-bottom:10px;font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#b2ab38;'>Sede:</strong>
                    ...
                    <tr>
                      <td style='padding-bottom:10px;font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#b2ab38;'>Indirizzo sede:</strong>
                        <span style='color:#201f1f;'> $selectedCampusAddressEscaped</span>
                      </td>
                    </tr>
                    <tr>
                      <td style='font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#b2ab38;'>Corso:</strong>
                        <span style='color:#201f1f;'> Game Design</span>
                      </td>
                    </tr>
                  </table>
                </td>
...
$academySubject = $isOrientamento
    ? 'Nuova iscrizione Orientamento – Game Design'
    : 'Nuova iscrizione Open Day – Game Design';
$academyOpenDayDateRow = $isOrientamento ? '' : "<p style='margin:0 0 8px;'><strong>Data Open Day:</strong> $selectedOpenDayDateLabelEscaped</p>";
$academyBody = "
<!DOCTYPE html>
<html lang='it'>
<head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,initial-scale=1'></head>
      ...
      <table width='580' cellpadding='0' cellspacing='0' style='background:#ffffff;border-radius:24px;overflow:hidden;max-width:580px;width:100%;'>
        ...
        <tr>
          <td align='center' style='padding:36px 40px 28px;background:#ffffff;'>
            ...
            <h1 style='margin:0;font-size:22px;font-weight:bold;color:#201f1f;font-family:Georgia,serif;'>
              Nuova Iscrizione $requestTypeLabelEscaped
            </h1>
          </td>
        </tr>
        ...
        <tr>
          <td style='padding:0 40px 24px;'>
            <table width='100%' cellpadding='0' cellspacing='0'>
              <tr>
                <td style='padding-bottom:10px;border-bottom:2px solid #b2ab38;'>
              ...
              <tr>
                <td style='padding-top:16px;font-size:14px;color:#201f1f;font-family:Arial,sans-serif;line-height:1.5;'>
                  ...
                  <p style='margin:0 0 8px;'><strong>Email:</strong> <a href='mailto:$userEmail' style='color:#b2ab38;text-decoration:none;'>$userEmail</a></p>
