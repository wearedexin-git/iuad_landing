...
function QuoteIcon() {
  return (
    <div className="w-[50px] h-[35px] md:w-[69px] md:h-[48px] shrink-0">
      ...
      >
        <path d={svgPaths.p1bfd52c0} fill="#B2AB38" />
      </svg>
    </div>
  );
}
...
function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  return (
    <div className="bg-white flex flex-col gap-4 p-8 md:p-10 rounded-3xl border-2 border-[#b2ab38] w-full h-full">
      <QuoteIcon />
...
export function TestimonialBlock({ onBookClick }: { onBookClick: () => void }) {
  ...
  if (!isDesktop) {
    return (
      <section
        ...
        className="relative bg-[#fbf6c3] py-16 overflow-hidden"
      >
        {/* Titolo animato */}
  ...
  return (
    <div
      id="testimonial"
      ref={sectionRef}
      className="relative bg-[#fbf6c3] overflow-hidden"
      style={{ height: "100vh" }}
    >
      {/* Titolo animato */}
      <div
