...
if ($courseMailLabel === '') {
    $courseMailLabel = 'Disegno Tecnico per la Moda 2D/3D';
}
...
$data = [
    ...
    'lang'                => 'it',
    'course'              => $landingConfig['course'] ?? ['disegno tecnico per la moda'],
    'origin'              => $origin,
...
if ($isOrientamento) {
    $redirectQueryParams['orientamento'] = '1';
} elseif ($selectedOpenDayDateLabel !== '') {
