    ...
    >
      ...
      >
        <h2 className={TITLE_CLS}>
          ...
          >
            Why become an <span className="lg:hidden">IUAD</span>
          </span>
          <span
            className="block"
            style={{ transform: `translateX(${p1Line2X}vw)`, opacity: p1LineOpacity }}
          >
            <span className="hidden lg:inline">IUAD </span>Creative
          </span>
        </h2>
      </div>
      ...
      >
        <div className="flex flex-col items-center gap-2 md:gap-4 max-w-[945px] w-full">
          ...
          >
            We start from theoretical foundations to take you straight into the workshop:{" "}
            <span className="font-bold">here you learn by experimenting</span>,{" "}
            <span className="font-bold">tackling</span>{" "}
            <span className="font-bold">real</span>{" "}
            <span className="font-bold">challenges</span> and{" "}
      ...
      >
        <div className="flex flex-col items-center gap-2 md:gap-4 max-w-[945px] w-full">
          ...
          <p className={BODY_CLS}>
            In the classroom we bring not only study programmes, but the live
            experience of{" "}
