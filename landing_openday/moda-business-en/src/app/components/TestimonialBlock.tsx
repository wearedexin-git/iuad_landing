...
const testimonials: Testimonial[] = [
  {
    ...
    quote:
      "The dual profile I gained here made all the difference: I know production processes from concept to finished product, but I can also manage budgets, timelines and suppliers. Today I coordinate the development of three lines for an Italian brand, and my design background lets me speak both with creatives and the commercial team.",
  },
  {
    name: "Davide",
    role: "Brand Manager",
    quote:
      "During the course I understood that real value lies in combining aesthetics and strategy. I learned to build marketing plans, analyse positioning and manage the brand lifecycle.",
  },
  {
    name: "Luca",
    role: "Studente",
    quote:
      "I never imagined I would study so much management alongside design — I am learning to think like a real manager. The great thing is you are not only studying theory: you tackle real cases, learn to present projects and work in teams just like in a company.",
  },
];
