...
if ($isOrientamento) {
    $origin = array_map(
        static fn ($value) => $value === 'openday' ? 'orientamento' : $value,
        $origin
    );
}
...
$userSubject = $isOrientamento
    ? 'Prenotazione confermata – Orientamento Design della Moda | IUAD'
    : 'Iscrizione confermata – Open Day Design della Moda | IUAD';
$userBody = "
<!DOCTYPE html>
<html lang='it'>
              ...
              <tr>
                <td>
                  ...
                  <table width='100%' cellpadding='0' cellspacing='0' style='margin-top:16px;'>
                    ...
                    <tr>
                      <td style='padding-bottom:10px;font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#8D9EBD;'>" . ($isOrientamento ? 'Tipo appuntamento' : 'Data Open Day') . ":</strong>
                    ...
                    <tr>
                      <td style='font-family:Arial,sans-serif;font-size:14px;'>
                        ...
                        <span style='color:#201f1f;'> Design della Moda</span>
                      </td>
                    </tr>
                  </table>
                </td>
...
$academySubject = $isOrientamento
    ? 'Nuova prenotazione Orientamento – Design della Moda'
    : 'Nuova iscrizione Open Day – Design della Moda';
$academyBody = "
<!DOCTYPE html>
<html lang='it'>
<head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,initial-scale=1'></head>
        ...
        <tr>
          <td align='center' style='padding:36px 40px 28px;background:#ffffff;'>
            ...
            <h1 style='margin:0;font-size:22px;font-weight:bold;color:#201f1f;font-family:Georgia,serif;'>
              " . ($isOrientamento ? 'Nuova Prenotazione Orientamento' : 'Nuova Iscrizione Open Day') . "
            </h1>
          </td>
        </tr>
            ...
            <table width='100%' cellpadding='0' cellspacing='0'>
              ...
              <tr>
                <td style='padding-top:16px;font-size:14px;color:#201f1f;font-family:Arial,sans-serif;line-height:1.5;'>
                  ...
                  <p style='margin:0 0 8px;'><strong>" . ($isOrientamento ? 'Tipo appuntamento' : 'Data Open Day') . ":</strong> $selectedOpenDayDateLabelEscaped</p>
                  <p style='margin:0 0 8px;'><strong>Indirizzo sede:</strong> $selectedCampusAddressEscaped</p>
                  <p style='margin:0 0 8px;'><strong>Corso:</strong> Design della Moda</p>
...
$redirectQuery = http_build_query(array_filter([
    ...
    'tipo' => $isOrientamento ? 'orientamento' : 'openday',
]));
