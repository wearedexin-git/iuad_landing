        ...
        <div className="flex flex-col gap-8 md:gap-10 max-w-[670px]">
          <div className="flex flex-col gap-6">
            ...
            <p className="font-sarabun font-light text-[20px] md:text-[24px] lg:text-[28px] text-[#201f1f] leading-[1.4]">
              Scegliere il corso Triennale in <span className="font-bold">Design della Moda</span> significa acquisire competenze che vanno ben oltre la semplice collezione. Imparerai a padroneggiare le skill tecniche e la conoscenza dei materiali, diventando un professionista capace di{" "}
