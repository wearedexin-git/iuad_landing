...
- **Scopo**: Immagine principale del corso di Design della Moda
...
- ✅ `src/assets/fashion_icon.svg` — icona moda usata dal componente `FashionIcon.tsx` (hero, blocco corso, testimonial, testo centrale; sostituisce l’ex `EyeIcon` su questa landing)
