...
if (!isset($campusesByApiValue[$selectedLocation])) {
    ob_end_clean();
    http_response_code(422);
    echo json_encode(['success' => false, 'message' => 'Invalid campus.']);
    exit();
}
...
if (!in_array($selectedOpenDayDate, $sessionsByCampusApiValue[$selectedLocation], true)) {
    ob_end_clean();
    http_response_code(422);
    echo json_encode(['success' => false, 'message' => 'Invalid Open Day date for the selected campus.']);
    exit();
}
...
if (empty($bearerToken)) {
    ...
    echo json_encode(['success' => false, 'message' => 'Server configuration is invalid.']);
    exit();
}
...
if ($curlError) {
    ...
    ob_end_clean();
    http_response_code(500);
    echo json_encode(['success' => false, 'message' => 'Could not connect to the API.']);
    exit();
}
...
if ($httpCode !== 200 || empty($responseData['steps_created'])) {
    $apiMessage = $responseData['message'] ?? 'Unknown error from the API.';
      ...
      <table width='580' cellpadding='0' cellspacing='0' style='background:#ffffff;border-radius:24px;overflow:hidden;max-width:580px;width:100%;'>
        ...
        <tr>
          <td align='center' style='padding:36px 40px 24px;background:#ffffff;'>
            <img
              src='$logoBase64'
              alt='IUAD Academy of Fashion and Design' width='80'
        ...
        <tr>
          <td align='center' style='padding:4px 40px 24px;'>
            ...
            <p style='margin:0;font-size:15px;color:#201f1f;font-family:Arial,sans-serif;line-height:1.6;'>
              We will be in touch shortly to confirm the details of your request.
            </p>
          </td>
        </tr>
                  ...
                  <table width='100%' cellpadding='0' cellspacing='0' style='margin-top:16px;'>
                    <tr>
                      <td style='padding-bottom:10px;font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#8D9EBD;'>Request type:</strong>
                        <span style='color:#201f1f;'> Open Day</span>
                      </td>
                    </tr>
                    <tr>
                      <td style='padding-bottom:10px;font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#8D9EBD;'>Campus:</strong>
                        <span style='color:#201f1f;'> $selectedCampusLabelEscaped</span>
                      </td>
                    </tr>
                    <tr>
                      <td style='padding-bottom:10px;font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#8D9EBD;'>Open Day date:</strong>
                        <span style='color:#201f1f;'> $selectedOpenDayDateLabelEscaped</span>
                      </td>
                    </tr>
                    <tr>
                      <td style='padding-bottom:10px;font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#8D9EBD;'>Campus address:</strong>
                        <span style='color:#201f1f;'> $selectedCampusAddressEscaped</span>
                      </td>
                    </tr>
                    <tr>
                      <td style='font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#8D9EBD;'>Programme:</strong>
                        <span style='color:#201f1f;'> Fashion Design</span>
                      </td>
                    </tr>
                  </table>
                </td>
...
$academySubject = 'New Open Day registration – Fashion Design';
$academyBody = "
<!DOCTYPE html>
<html lang='en'>
<head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,initial-scale=1'></head>
            ...
            <table width='100%' cellpadding='0' cellspacing='0'>
              <tr>
                <td style='padding-bottom:10px;border-bottom:2px solid #8D9EBD;'>
                  <span style='font-size:15px;font-weight:bold;color:#201f1f;font-family:Arial,sans-serif;'>Contact details</span>
                </td>
              </tr>
              <tr>
        ...
        <tr>
          <td style='padding:0 40px 36px;'>
            <table width='100%' cellpadding='0' cellspacing='0'>
              <tr>
                <td style='padding-bottom:10px;border-bottom:2px solid #8D9EBD;'>
                  <span style='font-size:15px;font-weight:bold;color:#201f1f;font-family:Arial,sans-serif;'>Request details</span>
                </td>
              </tr>
              <tr>
                <td style='padding-top:16px;font-size:14px;color:#201f1f;font-family:Arial,sans-serif;line-height:1.5;'>
                  <p style='margin:0 0 8px;'><strong>Request type:</strong> Open Day</p>
                  <p style='margin:0 0 8px;'><strong>Campus:</strong> $selectedCampusLabelEscaped</p>
                  <p style='margin:0 0 8px;'><strong>Open Day date:</strong> $selectedOpenDayDateLabelEscaped</p>
                  <p style='margin:0 0 8px;'><strong>Campus address:</strong> $selectedCampusAddressEscaped</p>
                  <p style='margin:0 0 8px;'><strong>Programme:</strong> Fashion Design</p>
                  <p style='margin:0;'><strong>How they heard about us:</strong> $howYouKnowsLabel</p>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td align='center' style='padding:16px 40px;background:#201f1f;border-radius:0 0 24px 24px;'>
            <p style='margin:0;font-size:11px;color:#ffffff;opacity:0.6;font-family:Arial,sans-serif;'>
              Sent automatically from the IUAD landing page &nbsp;·&nbsp; " . date('d/m/Y H:i') . "
            </p>
          </td>
        </tr>
