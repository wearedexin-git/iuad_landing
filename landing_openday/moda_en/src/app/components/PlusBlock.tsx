    ...
    >
      ...
      >
        <h2 className={TITLE_CLS}>
          ...
          >
            Why become <span className="lg:hidden">an </span>
          </span>
          <span
            className="block"
            style={{ transform: `translateX(${p1Line2X}vw)`, opacity: p1LineOpacity }}
          >
            <span className="hidden lg:inline">an </span>IUAD creative
          </span>
        </h2>
      </div>
      ...
      >
        <div className="flex flex-col items-center gap-2 md:gap-4 max-w-[945px] w-full">
          ...
          >
            We start from solid foundations and take you straight into the workshop:{" "}
            <span className="font-bold">here you learn by doing</span>,{" "}
            <span className="font-bold">taking on concrete challenges and real-world projects</span>.
          </p>
        </div>
      </div>
      ...
      >
        <div className="flex flex-col items-center gap-2 md:gap-4 max-w-[945px] w-full">
          ...
          <p className={BODY_CLS}>
            In the classroom we bring more than a syllabus: we bring the lived
            experience of{" "}
            <span className="font-bold">professionals</span> who{" "}
            <span className="font-bold">operate every day</span>
            {" "}at the top of the <span className="font-bold">industry</span>.
          </p>
