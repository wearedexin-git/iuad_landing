...
const testimonials: Testimonial[] = [
  {
    ...
    role: "Alumna",
    quote:
      "Here I discovered that behind every runway show there is a whole world: budgets, suppliers, production timelines. In my first interview they asked about a second-year project. What got me hired was explaining not only the concept, but how I would actually deliver it.",
  },
  {
    name: "Andrea",
    role: "Student",
    quote:
      "Here I learned I did not have to copy other designers—I had to find my own voice. Faculty push you to experiment, even to fail. I rebuilt the same collection three times before presenting it. Today that collection is in my portfolio and it opened the door to two internships.",
  },
  {
    name: "Martina",
    role: "Freelancer",
    quote:
      "The most valuable thing? Learning to run a shoot from start to finish—location, models, lighting, post-production, everything. I freelance now and can manage a set on my own. Clients appreciate that I am not only someone who can style looks, but someone who understands the technical and production side too.",
  },
];
    ...
    return (
      ...
      >
        ...
        <div className="relative flex justify-center mt-10">
          <CTAButton text="Talk to our students" onClick={onBookClick} />
        </div>
      </section>
    );
  }
