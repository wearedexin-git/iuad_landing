...
<body style='margin:0;padding:0;background:#fbdee6;font-family:Arial,sans-serif;'>
  <table width='100%' cellpadding='0' cellspacing='0' style='background:#fbdee6;padding:40px 20px;'>
    <tr><td align='center'>
      <table width='580' cellpadding='0' cellspacing='0' style='background:#ffffff;border-radius:24px;overflow:hidden;max-width:580px;width:100%;'>
        ...
        <tr>
          <td align='center' style='padding:36px 40px 24px;background:#ffffff;'>
            ...
            <h1 style='margin:0;font-size:22px;font-weight:bold;color:#801718;font-family:Georgia,serif;'>
          ...
          <td style='padding:0 40px 40px;'>
            <table width='100%' cellpadding='0' cellspacing='0'>
              <tr>
                <td>
                  <!-- Titolo sezione -->
                  <p style='margin:0 0 12px;font-size:15px;font-weight:bold;color:#801718;font-family:Arial,sans-serif;text-align:center;'>
                    Riepilogo Richiesta
                  </p>
                  <table width='100%' cellpadding='0' cellspacing='0'>
                  ...
                  <table width='100%' cellpadding='0' cellspacing='0' style='margin-top:16px;'>
                    ...
                    <tr>
                      <td style='padding-bottom:10px;font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#801718;'>Sede:</strong>
                    ...
                    <tr>
                      <td style='font-family:Arial,sans-serif;font-size:14px;'>
                        <strong style='color:#801718;'>Corso:</strong>
                        <span style='color:#201f1f;'> Regia per il Cinema e la Pubblicità</span>
                      </td>
                    </tr>
                  </table>
                </td>
      ...
      <table width='580' cellpadding='0' cellspacing='0' style='background:#ffffff;border-radius:24px;overflow:hidden;max-width:580px;width:100%;'>
        ...
        <tr>
          <td style='padding:0 40px 24px;'>
            <table width='100%' cellpadding='0' cellspacing='0'>
              <tr>
                <td style='padding-bottom:10px;border-bottom:2px solid #801718;'>
              ...
              <tr>
                <td style='padding-top:16px;font-size:14px;color:#201f1f;font-family:Arial,sans-serif;line-height:1.5;'>
                  ...
                  <p style='margin:0 0 8px;'><strong>Email:</strong> <a href='mailto:$userEmail' style='color:#801718;text-decoration:none;'>$userEmail</a></p>
