  ...
  return (
    <section className="relative bg-white py-20 md:py-32 px-5 md:px-10 lg:px-[calc(8.33%+35px)] overflow-hidden">
      <div className="max-w-[1130px] mx-auto">
        ...
        Qui ogni brief diventa un progetto pronto per essere presentato in agenzia.
        <RegiaIcon className="inline-block align-middle w-[30px] h-[30px] md:w-[45px] md:h-[45px] lg:w-[57px] lg:h-[57px]" />
        </div>
