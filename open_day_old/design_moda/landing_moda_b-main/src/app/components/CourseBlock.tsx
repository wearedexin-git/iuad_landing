        ...
        <div className="flex flex-col gap-8 md:gap-10 max-w-[670px]">
          <div className="flex flex-col gap-6">
            ...
            <p className="font-sarabun font-light text-[20px] md:text-[24px] lg:text-[28px] text-[#201f1f] leading-[1.4]">
              Completerai la tua formazione con la{" "}
              <span className="font-bold">ricerca e l'analisi dei nuovi trend</span>, imparando a tradurre l'estetica in mercato. Ma la moda è anche racconto: acquisirai la capacità di{" "}
              <span className="font-bold">realizzare shooting e video</span>, curando ogni dettaglio strategico, dal set alla scelta dei modelli fino allo{" "}
              <span className="font-bold">styling</span>, per comunicare la tua visione con un linguaggio contemporaneo e professionale.
            </p>
          </div>
