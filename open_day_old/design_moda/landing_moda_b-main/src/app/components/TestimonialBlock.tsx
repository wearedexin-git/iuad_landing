...
const testimonials: Testimonial[] = [
  {
    ...
    role: "Ex studentessa",
    quote:
      "Qui ho scoperto che dietro ogni sfilata c'è un mondo: budget, fornitori, tempi di produzione. Quando ho fatto il mio primo colloquio, mi hanno chiesto di un progetto del secondo anno. Quello che mi ha fatto assumere è stato saper spiegare non solo il concept, ma anche come l'avrei realizzato concretamente.",
  },
  {
    name: "Andrea",
    role: "Studente",
    quote:
      "Qui ho capito che non dovevo copiare altri designer, ma trovare la mia voce. I docenti ti spingono a sperimentare, anche a sbagliare. Ho rifatto la stessa collezione tre volte prima di presentarla. Oggi quella collezione è nel mio book e mi ha aperto le porte di due stage.",
  },
  {
    name: "Martina",
    role: "Freelance",
    quote:
      "La cosa più preziosa? Aver imparato a dirigere uno shooting dall'inizio alla fine. Location, modelle, luci, post-produzione: tutto. Adesso lavoro come freelance e so gestire un set in autonomia. I clienti apprezzano che non sono solo una che 'sa vestire', ma che capisco anche la parte tecnica e produttiva.",
  },
];
    ...
    <div className="bg-white flex flex-col gap-4 p-8 md:p-10 rounded-3xl border-2 border-[#8D9EBD] w-full h-full">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-2">
          <FashionIcon variant="tiny" className="w-[21px] h-[42px] shrink-0" />
