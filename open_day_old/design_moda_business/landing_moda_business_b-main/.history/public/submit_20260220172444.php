...
$data = [
    ...
    'lang'                => 'it',
    'course'              => ['corso specialistico in art direction & copywriting'],
...
$emailFrom        = 'marialessia.barbato@netengine.it';
$emailFromName    = 'Accademia IUAD';
$emailToAcademy   = 'marialessia.barbato@netengine.it'; // → prod: ufficioculturale@accademiamoda.it
                  ...
                  <table width='100%' cellpadding='0' cellspacing='0' style='margin-top:16px;'>
                    ...
                    <tr>
                      <td style='padding-bottom:10px;font-family:Arial,sans-serif;font-size:14px;'>
                        ...
                        <span style='color:#201f1f;'> Napoli</span>
                      </td>
                    </tr>
                    <tr>
...
$academySubject = 'Nuova iscrizione Open Day – Art Direction & Copywriting';
$academyBody = "
<!DOCTYPE html>
<html lang='it'>
<head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,initial-scale=1'></head>
            ...
            <table width='100%' cellpadding='0' cellspacing='0'>
              ...
              <tr>
                <td style='padding-top:16px;font-size:14px;color:#201f1f;font-family:Arial,sans-serif;line-height:1.5;'>
                  ...
                  <p style='margin:0 0 8px;'><strong>Sede:</strong> Napoli</p>
