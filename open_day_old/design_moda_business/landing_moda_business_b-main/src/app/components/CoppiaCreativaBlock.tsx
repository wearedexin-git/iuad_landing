        ...
        <div className="flex flex-col gap-8 md:gap-10 max-w-[670px]">
          <div className="flex flex-col gap-6">
            ...
            <p className="font-sarabun font-light text-[20px] md:text-[24px] lg:text-[28px] text-[#201f1f] leading-[1.4]">
              L'indirizzo in <span className="font-bold">Business & Management</span> nasce per formare il <span className="font-bold">Designer Manager</span>: una figura chiave che unisce il talento creativo alle attuali esigenze di mercato. È la scelta ideale se, oltre a muoverti tra tessuti e collezioni, desideri sviluppare{" "}
