        ...
        <div className="flex flex-col gap-8 md:gap-10 max-w-[670px]">
          <div className="flex flex-col gap-6">
            ...
            <p className="font-sarabun font-light text-[20px] md:text-[24px] lg:text-[28px] text-[#201f1f] leading-[1.4]">
              Durante il triennio svilupperai anche le{" "}
              <span className="font-bold">competenze linguistiche</span> necessarie per affacciarti con successo sui mercati esteri. Al termine del percorso, avrai la preparazione per inserirti subito nel mondo del lavoro come{" "}
